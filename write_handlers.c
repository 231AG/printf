...
{/*char is stored at left and paddind at buffers*/)
	int i = 0;
	char padd = ' ';
 ...
 * @flags: An active flags
 * @width: get the width.
 * @precision: the precision specification
 * @size: It specifies the size
 * Return: The number of characters to output.
 */
...
/**
 * write_num - Write number using the bufffer
 ...
 * @padd: Pades the character
 * @extra_c:the xtra characters
...
/**
 * write_unsgnd - This write an unsigned numbers
 * @is_negative: The number indicates
 ...
 * @ind: The index at which the # can begin in buffer
 * @length: the length of a num;
